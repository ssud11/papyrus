  ...
  const PAPYRUS = {
    inkwell: {
      ...
      tui: {
        ...
        suggestion: '#847F6C', permission: '#7A5418', permissionShimmer: '#8A5818', remember: '#4A38A0',
        ...
        bashBorder: '#2C5E64', ide: '#157E6A', fastMode: '#7A5418', fastModeShimmer: '#8A5818',
    ...
    vellum: {
      ...
      tui: {
        ...
        success: '#5E7252', error: '#7A2A18', warning: '#8A5818', warningShimmer: '#9A7822', merged: '#6A3A14',
        promptBorder: '#6A3A14', promptBorderShimmer: '#9A7822', planMode: '#244C46', autoAccept: '#5E7252',
        bashBorder: '#6A3A14', ide: '#2F5E54', fastMode: '#9A7822', fastModeShimmer: '#8A5818',
    ...
    noir: {
      ...
      slug: 'noir',
      mode: 'dark',
      tagline: 'Cold iron · true-black OLED, verdigris structure',
      ...
      chrome: {
        ...
        border: '#2E261A', borderSoft: '#221C12', badge: '#D89060', tabAccent: '#D89060',
      },
      ink: { ink: '#CFC4A8', inkSoft: '#AAA088', inkMuted: '#8A7E66', inkFaint: '#574E3C' },
      role: {
        comment: '#6E6858', keyword: '#DDA065', storage: '#DDA065', string: '#B5C078',
        escape: '#C8CE92', number: '#D4B068', langConst: '#B5C078', fn: '#80B89A',
        decorator: '#80B89A', klass: '#D26A55', iface: '#D26A55', typeAnno: '#C9A86A',
        attr: '#C9A86A', variable: '#CFC4A8', param: '#C2A878', prop: '#C5BCA0',
        selfThis: '#DDA065', operator: '#B0A484', punct: '#7E7460', tag: '#D26A55',
        mdLink: '#80B89A', error: '#D26A55', warning: '#DDA065', cursor: '#A8B580',
      },
      ansi: {
      ...
      tui: {
        base: 'dark', claude: '#80B89A', claudeShimmer: '#58B0A4', text: '#CFC4A8',
        inverseText: '#000000', inactive: '#8A7E66', inactiveShimmer: '#574E3C', subtle: '#2E261A',
        suggestion: '#6E6858', permission: '#D89060', permissionShimmer: '#DDA065', remember: '#DDA065',
        success: '#B5C078', error: '#D26A55', warning: '#D89060', warningShimmer: '#DDA065', merged: '#DDA065',
        promptBorder: '#D89060', promptBorderShimmer: '#DDA065', planMode: '#58B0A4', autoAccept: '#B5C078',
        bashBorder: '#DDA065', ide: '#80B89A', fastMode: '#D4B068', fastModeShimmer: '#DDA065',
        diffAdded: '#80B89A20', diffRemoved: '#D26A5520', rate_limit_fill: '#D89060', rate_limit_empty: '#2E261A',
        briefLabelYou: '#8A7E66', briefLabelClaude: '#80B89A',
      },
    },
    ...
    lamplight: {
      ...
      role: {
        ...
        mdLink: '#9ACBA8', error: '#E08068', warning: '#E8A878', cursor: '#C8C078',
      },
      ansi: {
      ...
      tui: {
        ...
        success: '#D4B878', error: '#E08068', warning: '#E8A878', warningShimmer: '#E8B080', merged: '#E8A878',
        ...
        diffAdded: '#9ACBA820', diffRemoved: '#E0806820', rate_limit_fill: '#E8A878', rate_limit_empty: '#352A20',
